...
from core.community_louvain import best_partition
from core.database import (get_table_with_foreign_keys, get_table_with_columns)
...
def main():
    ...
    get_html(tables=table_with_html_columns, relations=relations)
